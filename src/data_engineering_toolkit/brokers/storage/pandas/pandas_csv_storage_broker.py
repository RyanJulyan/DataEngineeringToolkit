...
class PandasCSVStorageBroker(IStorageBroker):
    def create(
        ...
        Args:
            dataframe (pd.DataFrame): DataFrame to be written to CSV.
            path_or_buf (Union[str, bytes]): File path or object. If not specified, the result is returned as a string.
            *args: Additional positional arguments passed to pandas.to_csv.
            **kwargs: Additional keyword arguments passed to pandas.to_csv.
        """
        dataframe.to_csv(path_or_buf=path_or_buf, *args, **kwargs)
    ...
    def read(
        ...
        Args:
            ...
            *args: Additional positional arguments passed to pandas.read_csv.
    ...
    def update(
        ...
        **kwargs
        ...
        updated_df.to_csv(filepath_or_buffer, index=False)
