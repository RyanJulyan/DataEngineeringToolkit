...
from data_engineering_toolkit.models.scheduling.job_model import Job
from data_engineering_toolkit.models.scheduling.scheduler_model import Scheduler
from data_engineering_toolkit.services.scheduling.job_builder_factory import (
    JobBuilderFactory,
)
...
class ScheduleManager:
    ...
    def create_scheduler(
        self, scheduler_name: str, jobs: Optional[Dict[str, Job]] = None
    ):
        """
    ...
    def time_until_the_next_execution(self, scheduler_name: str) -> Optional[float]:
        """
    ...
    def run_all(self, scheduler_name: str, delay_seconds: int = 0):
        ...
        """
        self.schedulers[scheduler_name].scheduler.run_all(delay_seconds=delay_seconds)
