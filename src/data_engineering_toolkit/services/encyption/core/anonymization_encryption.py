...
class AnonymizationEncryption(IEncryptionStrategy):
    ...
    def encrypt(self, message: str) -> str:
        ...
        Args:
            message (str): a string that we wish to encode/encrypt so that people cannot understand it
    ...
    def decrypt(self, encoded_message: str) -> str:
        ...
        Args:
            encoded_message (str): an encoded string that we wish to decode/decrypt so that people can understand it
