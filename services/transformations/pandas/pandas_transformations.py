...
class PandasDataFrameTransformations:
    ...
    def handle_missing_data(self, column_methods: List[HandleMissingDataColumn]) -> None:
        """
        ...
        for column_method in column_methods:
            if column_method.column_name in self.data.columns:
                if column_method.method == "fillna":
                    ...
                    self.data.dropna(subset=[column_method.column_name], inplace=True, **column_method.kwargs)
